...
export const CLE_FAVORIS_ANCIENNE_VERSION = "45ojuke.etiquettesPersonnalisees.coupsCoeur";
...
export const ETAPES_ASSISTANT = ["organisation", "reglages", "donnees", "style", "texte", "ruban", "cote", "decor", "favoris"];
